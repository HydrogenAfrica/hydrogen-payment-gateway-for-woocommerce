...
class WC_Gateway_Custom_Hydrogen extends WC_Gateway_Hydrogen_Subscriptions {
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			// 'split_payment'                    => array(
			// 	'title'       => __( 'Split Payment', 'woo-hydrogen' ),
			// 	'label'       => __( 'Enable Split Payment', 'woo-hydrogen' ),
			// 	'type'        => 'checkbox',
			// 	'description' => '',
			// 	'class'       => 'woocommerce_hydrogen_split_payment',
			// 	'default'     => 'no',
			// 	'desc_tip'    => true,
			// ),
			...
			// 	'title'             => __( 'Split Payment Transaction Charge', 'woo-hydrogen' ),
			// 	'type'              => 'number',
			// 	'description'       => __( 'A flat fee to charge the subaccount for this transaction, in Naira (&#8358;). This overrides the split percentage set when the subaccount was created. Ideally, you will need to use this if you are splitting in flat rates (since subaccount creation only allows for percentage split). e.g. 100 for a &#8358;100 flat fee.', 'woo-hydrogen' ),
			// 	'class'             => 'woocommerce_hydrogen_split_payment_transaction_charge',
			// 	'default'           => '',
			...
			// 	'title'       => __( 'Hydrogen Charges Bearer', 'woo-hydrogen' ),
			// 	'type'        => 'select',
			// 	'description' => __( 'Who bears Hydrogen charges?', 'woo-hydrogen' ),
			// 	'class'       => 'woocommerce_hydrogen_split_payment_charge_account',
			// 	'default'     => '',
			// 	'desc_tip'    => false,
			// 	'options'     => array(
			// 		''           => __( 'Select One', 'woo-hydrogen' ),
			// 		'account'    => __( 'Account', 'woo-hydrogen' ),
			// 		'subaccount' => __( 'Subaccount', 'woo-hydrogen' ),
			// 	),
			// ),
