...
class WC_Gateway_Hydrogen_One extends WC_Gateway_Custom_Hydrogen {
	...
	/**
	 * WC_Gateway_Hydrogen_One constructor.
	 */
	public function __construct() {

		$this->id = 'hydrogen-one';

		$gateway_title = $this->get_option( 'title' );

		if ( empty( $gateway_title ) ) {
			$gateway_title = __( 'One', 'woo-hydrogen' );
		}
