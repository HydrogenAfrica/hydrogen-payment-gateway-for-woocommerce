...
class WC_Gateway_Hydrogen_Two extends WC_Gateway_Custom_Hydrogen {
	...
	/**
	 * WC_Gateway_Hydrogen_Two constructor.
	 */
	public function __construct() {

		$this->id = 'hydrogen-two';

		$gateway_title = $this->get_option( 'title' );

		if ( empty( $gateway_title ) ) {
			$gateway_title = __( 'Two', 'woo-hydrogen' );
		}
