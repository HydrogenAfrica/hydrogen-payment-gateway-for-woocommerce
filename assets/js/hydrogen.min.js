jQuery(function(e){function a(){let e=[{display_name:"Plugin",variable_name:"plugin",value:"woo-hydrogen"},];return wc_hydrogen_params.meta_order_id&&e.push({display_name:"Order ID",variable_name:"order_id",value:wc_hydrogen_params.meta_order_id}),wc_hydrogen_params.meta_name&&e.push({display_name:"Customer Name",variable_name:"customer_name",value:wc_hydrogen_params.meta_name}),wc_hydrogen_params.meta_email&&e.push({display_name:"Customer Email",variable_name:"customer_email",value:wc_hydrogen_params.meta_email}),wc_hydrogen_params.meta_phone&&e.push({display_name:"Customer Phone",variable_name:"customer_phone",value:wc_hydrogen_params.meta_phone}),wc_hydrogen_params.meta_billing_address&&e.push({display_name:"Billing Address",variable_name:"billing_address",value:wc_hydrogen_params.meta_billing_address}),wc_hydrogen_params.meta_shipping_address&&e.push({display_name:"Shipping Address",variable_name:"shipping_address",value:wc_hydrogen_params.meta_shipping_address}),wc_hydrogen_params.meta_products&&e.push({display_name:"Products",variable_name:"products",value:wc_hydrogen_params.meta_products}),e}function n(){let e={};return wc_hydrogen_params.card_channel&&(wc_hydrogen_params.banks_allowed&&(e.banks=wc_hydrogen_params.banks_allowed),wc_hydrogen_params.cards_allowed&&(e.card_brands=wc_hydrogen_params.cards_allowed)),e}function t(a,n){let t=`
      ...
      `;e("body").append(t),e("#okButton").on("click",function(){window.location.href=n})}function r(){let e=[];return wc_hydrogen_params.bank_channel&&e.push("bank"),wc_hydrogen_params.card_channel&&e.push("card"),wc_hydrogen_params.ussd_channel&&e.push("ussd"),wc_hydrogen_params.qr_channel&&e.push("qr"),wc_hydrogen_params.bank_transfer_channel&&e.push("bank_transfer"),e}async function o(){e("#wc-hydrogen-form").hide(),e("form#payment-form, form#order_review").find("input.hydrogen_txnref").val("");let a=Number(wc_hydrogen_params.amount),o=window.location.href.replace("/order-pay/","/order-received/");window.obj={amount:a,email:wc_hydrogen_params.email,currency:wc_hydrogen_params.currency,description:"Payment for items ordered with ID "+wc_hydrogen_params.meta_order_id,customerName:wc_hydrogen_params.meta_name,meta:wc_hydrogen_params.meta_name,callback:o,isAPI:!0,returnRef:2},window.token=wc_hydrogen_params.key,new URL(o),Array.isArray(r())&&r().length&&(paymentData.channels=r(),e.isEmptyObject(n())||(paymentData.metadata.custom_filters=n()));let i=new URL(window.location.href.replace("/order-pay/","/order-received/")),d=new URLSearchParams(i.search),s=d.get("TransactionRef"),l=d.get("key");if(!s){let c=i.search.substring(1).split("&");for(let m of c){let[u,p]=m.split("=");if("TransactionRef"===u){s=p;break}}}if(!l){let f=i.search.indexOf("key=");if(-1!==f){let y=i.search.substring(f),h=y.indexOf("&");-1!==h&&(y=y.substring(0,h)),l=y.split("=")[1]}}if(s){if(window!==window.parent){var g={event:"callback",transactionRef:s};window.parent.postMessage(JSON.stringify(g),"*")}else{wc_hydrogen_params.meta_order_id,wc_hydrogen_params.hydrogen_wc_redirect_url;let b=window.location.href.replace(/\/checkout\/order-received\/\d+\/.*/,"");b+="/cart/",k(s)}}else{async function $(){try{let e=await handlePgData(window.obj,window.token,v);console.log("return transaction ref",e),s=e,window.innerWidth>768?function e(){let a=document.getElementById("hydrogenPay_modal");a&&(a.style.height="682px",a.style.marginTop="60px");let n=document.getElementById("hydrogenPay_myModal");n&&(n.style.zIndex="9999")}():function e(){let a=document.getElementById("hydrogenPay_modal");a&&(a.style.height="682px",a.style.marginTop="40px");let n=document.getElementById("hydrogenPay_myModal");n&&(n.style.zIndex="9999")}()}catch(a){console.error("Error occurred:",a)}}$()}function v(e){window.parent.postMessage(JSON.stringify({event:"close",transactionRef:e}),"*")}function k(a){let n=`
          <style>
            .spinner-overlay {
              position: fixed;
              top: 0;
