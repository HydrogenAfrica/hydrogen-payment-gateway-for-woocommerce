...
class WC_Gateway_Hydrogen_Four extends WC_Gateway_Custom_Hydrogen {
	...
	/**
	 * WC_Gateway_Hydrogen_Four constructor.
	 */
	public function __construct() {

		$this->id = 'hydrogen-four';

		$gateway_title = $this->get_option( 'title' );

		if ( empty( $gateway_title ) ) {
			$gateway_title = __( 'Four', 'woo-hydrogen' );
		}
