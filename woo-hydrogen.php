...
function tbz_wc_hydrogen_init() {
	...
	require_once dirname( __FILE__ ) . '/includes/custom-gateways/class-wc-gateway-hydrogen-one.php';
	require_once dirname( __FILE__ ) . '/includes/custom-gateways/class-wc-gateway-hydrogen-two.php';
	require_once dirname( __FILE__ ) . '/includes/custom-gateways/class-wc-gateway-hydrogen-three.php';
	require_once dirname( __FILE__ ) . '/includes/custom-gateways/class-wc-gateway-hydrogen-four.php';
	require_once dirname( __FILE__ ) . '/includes/custom-gateways/class-wc-gateway-hydrogen-five.php';
